...
OpenFTC-app-turbo removes the OnBotJava and Blocks programming systems for teams that don't use or need them, speeding up deploy time by removing the large files required for those systems. 
