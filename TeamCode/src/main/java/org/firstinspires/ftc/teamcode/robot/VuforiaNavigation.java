...
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.AXIAL_GAIN;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.CAMERA_CHOICE;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.CLOSE_ENOUGH;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.LATERAL_GAIN;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.MAX_TARGETS;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.ON_AXIS;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.VUFORIA_LICENSE_KEY;
import static org.firstinspires.ftc.teamcode.robot.RevbotValues.YAW_GAIN;

/**
 * This is NOT an opmode.
 *
 * This class is used to define all the specific navigation tasks for the Target Tracking Demo
 * It focuses on setting up and using the VuforiaNavigation Library, which is part of the 2016-2017 FTC SDK
 *
...
public class VuforiaNavigation {
    ...
    private boolean             targetFound;    // set to true if VuforiaNavigation is currently tracking a target
    ...
    /**
     * Start tracking VuforiaNavigation images
     */
     ...
     */
    public void initVuforia(LinearOpMode opMode, Revbot robot) {
        ...
        /**
         * Start up VuforiaNavigation, telling it the id of the view that we wish to use as the parent for
         * the camera monitor.
        ...
        // Get your own VuforiaNavigation key at  https://developer.vuforia.com/license-manager
        // and paste it here...
        ...
        VuforiaTrackable trackable = targets.get(0);
        trackable.setName("relicVuMarkTemplate");
