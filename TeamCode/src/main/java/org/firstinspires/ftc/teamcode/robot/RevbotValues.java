...
public class RevbotValues {
    ...
    public static final double LEFT_CLAW_OPENED_VALUE = 0.2;
    public static final double RIGHT_CLAW_CLOSED_VALUE = 0.2;
    public static final double RIGHT_CLAW_OPENED_VALUE = 0.8;
    ...
    // CR values
    public static final double CR_FORWARDS_VALUE = 0;
    public static final double CR_BACKWARDS_VALUE = 1;
    public static final double CR_STOP_VALUE = 0.5;
